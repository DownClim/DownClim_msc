...
#| message: false
#| warning: false
#| fig-cap: "Fig 2. Histograms of monthly mean temperature (°C) in Côte d'Ivoire for all CMIP6 and CORDEX projections before and after downscaling compared to CHELSA 2. Bar colours indicate the month. Histograms for French Guiana, Côte d'Ivoire and New Caledonia for temperature are shown in Supplementary Fig. S1 and for precipitation in Supplementary Fig. S2."
...
#| message: false
#| warning: false
#| fig-cap: "Fig. S1. Histograms of monthly mean temperature (°C) in French Guiana, Côte d'Ivoire and New Caledonia for all CMIP6 and CORDEX projections before and after downscaling compared to CHELSA 2. Bar colours indicate the month."
g <- vroom::vroom("results/evaluation/histograms.tsv") %>% 
  filter(variable == "tas") %>% 
  group_by(origin, type, area, month) %>% 
  mutate(density = count / sum(count)) %>% 
...
#| message: false
#| warning: false
#| fig-cap: "Fig. S2. Histograms of monthly precipitaiton (mm) in French Guiana, Côte d'Ivoire and New Caledonia for all CMIP6 and CORDEX projections before and after downscaling compared to CHELSA 2. Bar colours indicate the month."
g <- vroom::vroom("results/evaluation/histograms.tsv") %>% 
  filter(variable == "pr") %>% 
  group_by(origin, type, area, month) %>% 
  mutate(density = count / sum(count)) %>% 
