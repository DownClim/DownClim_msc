...
vroom::vroom("results/evaluation/histograms.tsv") %>% 
  ...
  theme_bw() +
  facet_wrap(~ area ~ paste(origin, type), scales = "free_y") +
  theme(axis.title = element_blank()) +
  scale_color_discrete("") + scale_fill_discrete("") +
  theme(legend.position = "bottom") +
  ggtitle("Mean monthly temperature at surface (°C)", 
          "At 30' and for all months.")
```
...
vroom::vroom("results/evaluation/histograms.tsv") %>% 
  ...
  scale_color_discrete("") + scale_fill_discrete("") +
  theme(legend.position = "bottom") +
  ggtitle("Total monthly precipitation (mm)", 
          "At 30' and for all months.")
```
